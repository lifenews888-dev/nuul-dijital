...
const NAV: NavItem[] = [
  ...
  { href: "/admin/catalogue/services", label: "Үйлчилгээ", icon: Sparkles, section: "content" },
  { href: "/admin/catalogue/software", label: "Программ хангамж", icon: AppWindow, section: "content" },
  { href: "/admin/catalogue/categories", label: "Программын ангилал", icon: Tags, section: "content" },
  ...
  { href: "/admin/domains/orders", label: "Домэйн захиалга", icon: Globe, section: "domains" },
  { href: "/admin/services/orders", label: "Үйлчилгээ захиалга", icon: Server, section: "domains" },
  { href: "/admin/domains/pricing", label: "TLD үнэ", icon: Tags, section: "domainsManage" },
  { href: "/admin/support", label: "Дэмжлэг", icon: LifeBuoy, section: "leads" },
  { href: "/admin/leads", label: "Лидүүд", icon: Inbox, section: "leads" },
  { href: "/admin/software-quotes", label: "Лицензийн хүсэлт", icon: KeyRound, section: "leads" },
