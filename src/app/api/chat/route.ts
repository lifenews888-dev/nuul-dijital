...
ХОЛБОО: утас +976 8080 1677, имэйл hello@nuul.digital.
...
function fallbackReply(text: string): string {
  ...
  if (/(холбо|утас|имэйл|уулз|contact|meet)/.test(t))
    return "Бидэнтэй холбогдох: утас +976 8080 1677, имэйл hello@nuul.digital. Эсвэл /contact хуудсаар зурвас үлдээх, уулзалт захиалах боломжтой.";
