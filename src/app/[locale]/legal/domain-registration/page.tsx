...
export const metadata = buildMetadata({
  title: "Домэйн бүртгэлийн нөхцөл",
  path: "/legal/domain-registration",
});

export default async function DomainRegistrationPage() {
  const t = await getTranslations("pages.legal");
  const sections = t.raw("domainRegistration") as { h: string; p: string }[];
  return (
    <>
      <PageHeader label={t("label")} title={t("domainRegistrationTitle")} />
